        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                {/* <p className="text-sm font-bold leading-6 text-gray-400">Solutions</p> */}
                      ...
                      <Link
                        ...
                        className={`text-sm leading-6 ${
                          router.pathname === item.href
                            ? 'text-white dark:text-dark-txt font-semibold'
              ...
              <div className="">
                {/* <p className="text-sm font-bold leading-6 text-gray-400">Support</p> */}
                <ul className="mt-4 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                {/* <p className="text-sm font-bold leading-6 text-gray-400">DAO</p> */}
                <ul className="mt-4 space-y-4">
              ...
              <div className="">
                {/* <p className="text-sm font-bold leading-6 text-gray-400">Legal</p> */}
                <ul className="mt-4 space-y-4">
