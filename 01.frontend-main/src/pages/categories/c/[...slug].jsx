...
import FeaturedCourses from '@/pages/components/courses/list/FeaturedCourses';
...
export async function getServerSideProps(context) {
  ...
  const coursesRes = await axios.get(
    ...
    }/api/courses/search/?p=${1}&page_size=${12}&max_page_size=${100}&filter=${'views'}&order=${'-published'}&search=${''}&rating=${''}&language=${''}&duration=${''}&category=${slug}&level=${''}&pricing=${''}&author=${''}`,
  );
