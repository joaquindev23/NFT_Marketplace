...
import { videoDuration } from '@/helpers/fixedVideoDuration';

export default function VideoDurationFilter({ setDuration }) {
                ...
                {videoDuration.map((duration) => (
                  ...
                  >
                    ...
                    <div className="mt-1.5 text-sm dark:text-dark-txt-secondary text-gray-700">
                      {duration.value === '17-99999999' ? '17+' : duration.value} Hours
                    </div>
                  </button>
                ))}
              </div>
