...
import LoadCoursesWishlist from '../../../api/wishlist/LoadCoursesWishlist';
import CourseList from '../courses/components/CourseList';

const SeoList = {
  title: 'Wishlist - My Courses, Products, Wishlist & Orders | Boomslag NFT Marketplace',
  description:
...
export default function Wishlist() {
  ...
  const fetchCourses = useCallback(
    async (page, searchBy) => {
      setLoading(true);
      const res = await LoadCoursesWishlist(
        page,
        pageSize,
        maxPageSize,
        filterBy,
      ...
      <div className="flex">
        <div className=" flex gap-x-4">
          <div className="w-full ">
            <form onSubmit={(e) => onSubmit(e)} className="   flex border">
              <div className=" flex flex-grow items-stretch ">
                <input
                  ...
                  className="text-md duration block  w-full border focus:ring-none focus:outline-none border-dark py-2.5 pl-4 font-medium transition ease-in-out dark:bg-dark-second dark:text-dark-txt"
