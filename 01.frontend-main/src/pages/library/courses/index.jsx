...
import LoadPaidCourses from '@/api/courses/LoadPaidCourses';
...
export default function CoursesLibrary() {
  ...
  const fetchCourses = useCallback(
    async (page, searchBy) => {
      setLoading(true);
      const res = await LoadPaidCourses(
        page,
        pageSize,
        maxPageSize,
        filterBy,
    ...
    [pageSize, maxPageSize, filterBy, orderBy, filterByAuthor, filterByCategory],
  );
...
CoursesLibrary.getLayout = function getLayout(page) {
