...
import { setCourseStep2 } from '@/redux/actions/create/create';
    ...
    <div className="dark:bg-dark-main">
      ...
      <div className="grid w-full place-items-center py-14">
        <h2 className="font-recife-bold mx-12 text-2xl dark:text-dark-txt md:mx-0 md:text-4xl">
          What shall be the name of this training, young apprentice?
        </h2>
        <p className="font-regular mx-12 mt-4 text-sm md:mx-0 md:text-lg dark:text-dark-txt-secondary">
          It does not have to be set in stone, for as the force flows, so too can the name change.
        </p>
        <div className="relative mt-12">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              dispatch(setCourseStep2(e.target.value));
            }}
          ...
          <div className="mt-3 sm:mt-0 sm:ml-4">
            {title && title.length <= 60 ? (
              <button
                type="button"
                onClick={() => {
                  router.push('/sell/courses/create/3');
                }}
