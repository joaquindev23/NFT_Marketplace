...
import FriendRequestsSec from '../components/FriendRequestsSec';
import Layout from '@/hocs/Layout';
import { useSelector } from 'react-redux';

const SeoList = {
  title: 'Manage Friend Requests - Boomslag',
  description:
    'Manage your friend requests on boomslag. Connect with other users in the NFT community.',
  href: '/friends',
...
export default function FriendRequests() {
  ...
  return (
    <FriendsLayout>
      ...
      <FriendRequestsSec friendRequests={friendRequests} />
    </FriendsLayout>
  );
}
