...
class Order(models.Model):
    ...
    amount = models.DecimalField(max_digits=9, decimal_places=2, default=Decimal('0'), blank=True, null=True)
...
class OrderItem(models.Model):
    ...
    color_hex = models.CharField(max_length=255, blank=True, null=True)
    ...
    weight_name = models.CharField(max_length=255, blank=True, null=True)
    weight_price = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    size = models.UUIDField(blank=True, null=True)
    size_name = models.CharField(max_length=255, blank=True, null=True)
    size_price = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    material = models.UUIDField(blank=True, null=True)
    material_name = models.CharField(max_length=255, blank=True, null=True)
    material_price = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
