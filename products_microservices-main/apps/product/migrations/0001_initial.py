    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('welcome_message', models.TextField(blank=True, max_length=1200, null=True)),
                ('congrats_message', models.TextField(blank=True, max_length=1200, null=True)),
                ...
                ('documents', models.ManyToManyField(blank=True, related_name='product_documents', to='product.Documents')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position_id', models.IntegerField(blank=True, null=True)),
                ('title', models.CharField(max_length=255)),
                ('file', models.FileField(blank=True, null=True, upload_to='marketplace/resources')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255)),
                ('user', models.UUIDField(blank=True, null=True)),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='whatlearnt_belongs_to_product', to='product.product')),
            ],
        ),
        migrations.CreateModel(
            name='Weight',
        ...
        migrations.AddField(
            model_name='product',
            name='requisites',
            field=models.ManyToManyField(blank=True, related_name='requisite_from_product', to='product.Requisite'),
        ),
        migrations.AddField(
            model_name='product',
            name='resources',
            field=models.ManyToManyField(blank=True, related_name='resources_from_product', to='product.Resource'),
        ),
        migrations.AddField(
            model_name='product',
            name='shipping',
        ...
        migrations.AddField(
            model_name='product',
            name='what_learnt',
            field=models.ManyToManyField(blank=True, related_name='whatlearnt_from_product', to='product.WhatLearnt'),
        ),
        migrations.AddField(
            model_name='product',
            name='who_is_for',
            field=models.ManyToManyField(blank=True, related_name='whoisfor_from_product', to='product.WhoIsFor'),
        ),
        migrations.AddField(
            model_name='material',
            name='product',
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_documents_attached', to='product.product'),
        ),
        migrations.AddField(
            model_name='details',
            name='product',
